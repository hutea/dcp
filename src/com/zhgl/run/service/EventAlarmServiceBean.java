...
public class EventAlarmServiceBean extends DAOSupport<EventAlarm> implements
	...
	public long countToday(String tcsid) {
		...
		Query query = em
				.createQuery(
						"select count(o.id) from EventAlarm o where o.towerCraneStatus.id=?1 and o.createTime>=?2 and o.createTime<?3 and o.visible=true")
	...
	public EventAlarm nowArarm(String tcsid) {
		...
		Query query = em
				.createQuery(
						"select o from EventAlarm o where o.towerCraneStatus.id=?1 and o.createTime>=?2 and o.createTime<=?3 and o.visible=true order by id desc")
				.setParameter(1, tcsid).setParameter(2, startDate)
				.setParameter(3, endDate);
		try {
	...
	public HashMap<String, String> getTypeCount(Date beginDate, Date endDate,
		...
		Query query = em
				.createQuery(
						"select o.alarmType,count(alarmType) from EventAlarm o where o.towerCraneStatus.id=?1 and o.createTime>=?2 and o.createTime<?3 and o.visible=true group by o.alarmType")
	...
	public HashMap<String, String> getTypeCount(String id) {
		Query query = em
				.createQuery(
						"select o.alarmType,count(alarmType) from EventAlarm o where o.towerCraneStatus.id=?1 and o.visible=true group by o.alarmType")
				.setParameter(1, id);
		HashMap<String, String> map = new HashMap<String, String>();
		for (Object obj : query.getResultList()) {
			Object[] result = (Object[]) obj;
	...
	public int getCount(Date beginDate, Date endDate, String tid) {
		Query query = em
				.createNativeQuery(
						"select count(o.id) from  t_eventAlarm o where o.visible=?1 and o.tcstatus_id=?2 and o.createTime<?3 and o.createTime>=?4")
