...
<div class="row">
	...
	<div class="col-md-3">
		...
		到 <input type="text" value="${pageView.currentPage}" id="inputPage" onkeyup="this.value=this.value.replace(/\D/g,'')" onafterpaste="this.value=this.value.replace(/\D/g,'')"  maxlength="5" style="width:40px;height: 25px;vertical-align:baseline;"> 页
