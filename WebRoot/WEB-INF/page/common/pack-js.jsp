...
<script
	src="${pageContext.request.contextPath}/resource/template/js/jquery/jquery-2.0.3.min.js"></script>
<script
	src="${pageContext.request.contextPath}/resource/template/js/jquery-ui-1.10.3.custom/js/jquery-ui-1.10.3.custom.min.js"></script>
<script
	src="${pageContext.request.contextPath}/resource/template/bootstrap-dist/js/bootstrap.min.js"></script>

<!-- DATE RANGE PICKER -->
<script
	src="${pageContext.request.contextPath}/resource/template/js/bootstrap-daterangepicker/moment.min.js"></script>

<script
	src="${pageContext.request.contextPath}/resource/template/js/bootstrap-daterangepicker/daterangepicker.min.js"></script>
