  		...
  		<div class="row" style="padding: 8px;">
			<div class="col-md-12 form-inline">设备传感器实时数据
				...
				<select name="refreshTime" id="selectID" class="form-control"> 
					<option value="1" <c:if test="${param.refreshTime==1}">selected="selected"</c:if> >1秒</option>
					<option value="2" <c:if test="${param.refreshTime==2}">selected="selected"</c:if> >2秒</option>
					<option value="3" <c:if test="${param.refreshTime==3}">selected="selected"</c:if> >3秒</option>
					<option value="4" <c:if test="${param.refreshTime==4}">selected="selected"</c:if> >4秒</option>
					<option value="5" <c:if test="${param.refreshTime==5}">selected="selected"</c:if> >5秒</option>
					<option value="10" <c:if test="${param.refreshTime==10}">selected="selected"</c:if> >10秒</option>
